...
abstract class AbstractRepository
{
    ...
    {
        // create builder object with eager loading client and driver
    ...
    protected function addFilter($builder, $fieldName, $_)
    {
        ...
        switch ($fieldName)
        {
            ...
            # syntax '_drivers' : array of driver_id
            case '_drivers':
                $builder->whereHas('driver', function ($query) use ($_) {
                    $query->whereIn('id', $_);
                });
                break;
            */
